      ...
      <div className="container mx-auto px-4 lg:px-8 py-8">
        ...
        {bookmarks.length === 0 ? (
          <div className="text-center py-12">
            ...
            <Link to="/" className="inline-flex items-center px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-lg transition-colors">
              Browse Series
            </Link>
          </div>
        ) : (
                          ...
                          <div className="flex-1 sm:ml-4 min-w-0">
                            ...
                            {latestChapter && (
                              <Link
                                ...
                                className="inline-flex items-center px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white text-sm rounded-lg transition-colors"
                              >
