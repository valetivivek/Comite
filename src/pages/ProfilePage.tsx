      ...
      <div className="container mx-auto px-4 lg:px-8 py-8">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="relative">
                {isEditing ? (
                  ...
                  <div className="w-20 h-20 rounded-full overflow-hidden bg-manga-accent flex items-center justify-center">
                    {profilePicture ? (
                      <img
                        src={profilePicture}
                        alt="Profile"
                ...
                {isEditing && (
                  <label className="absolute -bottom-1 -right-1 w-6 h-6 bg-manga-accent rounded-full flex items-center justify-center cursor-pointer hover:brightness-95 transition-colors">
              ...
              <div className="flex-1">
                ...
                {isEditing ? (
                  <textarea
                    ...
                    className="w-full p-3 bg-manga-surface border border-manga-border rounded-lg text-manga-text placeholder-manga-muted focus:outline-none focus:ring-2 focus:ring-manga-accent focus:border-transparent resize-none"
                    rows={3}
                  />
                ) : (
                ...
                {isEditing ? (
                  <>
                    <button
                      ...
                      className="p-2 bg-manga-accent hover:brightness-95 rounded-lg transition-colors"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            >
              <BookmarkIcon className="h-8 w-8 text-manga-accent mx-auto mb-2" />
            ...
            <motion.div
              ...
              className="card p-6 text-center"
            >
              <ClockIcon className="h-8 w-8 text-manga-accent mx-auto mb-2" />
              <h3 className="text-2xl font-bold text-manga-text mb-1">
                {totalReadChapters}
              </h3>
            ...
            <motion.div
              ...
              className="card p-6 text-center"
            >
              <StarIcon className="h-8 w-8 text-manga-accent mx-auto mb-2" />
              <h3 className="text-2xl font-bold text-manga-text mb-1">
